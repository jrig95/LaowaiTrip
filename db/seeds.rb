...
first_place = Place.new(user: first_user, city_name: "Shanghai", place_name: "Shanghai W on the Bund", description: "A beautiful hotel on the north bund ", price_by_night: 159, view: "bund view", available: true,max_guest: 4,number_bathrooms: 4, address:"66 Lvshun Road, Shanghai", number_rooms: 4, amenities: "washer and dryer, towel rack, hot tub")
...
second_place = Place.new(user: first_user, city_name: "Shanghai", place_name: "The Peace Hotel", description: "A beautiful hotel next to the bund", price_by_night: 160, view: "bund view", available: true,max_guest: 6, number_bathrooms: 2, address:"20 Nanjing Road East",number_rooms: 4, amenities: "washer and dryer, towel rack, hot tub")
second_place.photo.attach(io: second_place_image, filename: 'shanghai_peace.jpeg', content_type: 'image/jpeg')
second_place.save!
