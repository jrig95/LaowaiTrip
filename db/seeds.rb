...
#   first_place_image_one = URI.open('https://t-cf.bstatic.com/xdata/images/hotel/max1280x900/327419823.jpg?k=482a587ee9cd4aca228e48c7e6d38173fafd2981e93dd9367532b2a93d0c8f6b&o=&hp=1')
#   first_place_image_two = URI.open('https://ak-d.tripcdn.com/images/0204g1200097ae0x0D5A0_Z_1080_808_R5_D.jpg')
#   first_place_image_three = URI.open('https://ak-d.tripcdn.com/images/200p0k000000c6v4p95A5_Z_1080_808_R5_D.jpg')
#   first_place = Place.new(user: first_user, city_name: "Shanghai", place_name: "Shanghai W on the Bund", description: "A beautiful hotel on the north bund ", price_by_night: 281, view: "bund view", available: true,max_guest: 4,number_bathrooms: 1, address:"Hongkou District, Shanghai, China", number_rooms: 4, amenities: "washer and dryer, towel rack, hot tub", link: "https://us.trip.com/hotels/shanghai-hotel-detail-7270168/w-shanghai-the-bund/?cityId=2&checkIn=2022-01-10&checkOut=2022-01-11&adult=1&children=0&crn=1&ages=&travelpurpose=0&curr=USD&link=button&hoteluniquekey=H4sIAAAAAAAAAONaw8jFK8Fo8B8GGIWYOBilpjFyPD3fd4fJgMORAQS-zHbwBDPMFjgE8ExilOKE8QQ9HlaJrDOb4-DExrHqH6MEywzGGfd2M29kBCt4UOiwg5HpBONMpgVMM4HCu5igqg4xsXIcZJZgOsXEcImJ4RYTwyMmhldMDJ-YGH7BlDQxM3QxM0xihiicxcywiJlBiBXsLCkF46Q0M3MDS2PjZEtDExODlERLUwNzSxMzi1TDJMMUQxMFbo1Tq973sRmJnWIUNjQzMTCzsLS0MDQ3MNHLTjHKN7BilmJ082AMYjM0cLOwdI2S4WJ29osUBDua4YO9FHNosItiePTG_W_qJB2SWFPzdEODMy5yFDB2MbIJMHowRjCuYmQAABjpz2o9AQAA", thirdparty: "trip.com" )
#   first_place.photos.attach(io: first_place_image_one, filename: 'shanghai_w.jpeg', content_type: 'image/jpeg')
#   first_place.photos.attach(io: first_place_image_two, filename: 'shanghai_w.jpeg', content_type: 'image/jpeg')
#   first_place.photos.attach(io: first_place_image_three, filename: 'shanghai_w.jpeg', content_type: 'image/jpeg')
#   first_place.save!
...
# # 1. Trip
#   first_chengdu_place_image_one = URI.open('https://ak-d.tripcdn.com/images/0202r1200086mow8uE074_Z_1080_808_R5_D.jpg')
#   first_chengdu_place_image_two = URI.open('https://ak-d.tripcdn.com/images/0203l120008df8pbq9C13_Z_1080_808_R5_D.jpg')
#   first_chengdu_place_image_three = URI.open('https://ak-d.tripcdn.com/images/0205i1200088amkpgCDFD_Z_1080_808_R5_D.jpg')
#   first_chengdu_place = Place.new(user: first_user, city_name: "Chengdu", place_name: "W Chengdu", description: "This hotel makes a great place to kick back and relax after a long day of sightseeing. For guests' convenience, airport pickup can be arranged.", price_by_night: 1200, view: "city view", available: true,max_guest: 6, number_bathrooms: 2, address:"No. 300 Jiaozi Avenue, Gaoxin District,, Chengdu, Sichuan, China",number_rooms: 4, amenities: "washer and dryer, towel rack, hot tub", link: "https://us.trip.com/hotels/chengdu-hotel-detail-6752442/w-chengdu/?cityId=28&checkIn=2022-01-11&checkOut=2022-01-12&adult=1&children=0&crn=1&ages=&travelpurpose=0&curr=USD&link=title&hoteluniquekey=H4sIAAAAAAAAAONaz8jFK8Fo8B8GGIWYOBilZjJy3Nh6_QCzAYcjAwg0THTwBDMUpjgE8ExilOKE8QTlW18H7mic6ODExvFrLqMEywzGXRPnMK9gZNzICFbDkOqwg5HpBOMGxgVMH49uZN_FBFV4iImV46yIBMspJoZLTAy3mBgeMTG8YmL4xMTwC6akiZmhi5lhEjNE4SxmhkXMDEKsYJdJKRinpZikpFiYmSSnGphYphpYGJkZGpobpZhbWJibJRunKnBrNFz60sdmJHaKUdjQzMTAzMLS0sLQ3MBELzvFKN_AilmK0c2DMYjNxcjV0tUtSoaL2dkvUhDi6A_2UsyhwS6KHGtkolKqJR2SWFPzdEODMy5xFDB2MbIJMHowRjCuYmQAAG7AKetAAQAA", thirdparty: "trip.com")
#   first_chengdu_place.photos.attach(io: first_chengdu_place_image_one, filename: 'chengdu.jpeg', content_type: 'image/jpeg')
#   first_chengdu_place.photos.attach(io: first_chengdu_place_image_two, filename: 'chengdu.jpeg', content_type: 'image/jpeg')
#   first_chengdu_place.photos.attach(io: first_chengdu_place_image_three, filename: 'chengdu.jpeg', content_type: 'image/jpeg')
#   first_chengdu_place.save!
...
CSV.foreach(csv, headers: true, col_sep: "|") do |row|
     ...
     place.photos.attach(io: URI.open(row["images"][1]), filename: "hotel.jpg")
     place.photos.attach(io: URI.open(row["images"][2]), filename: "hotel.jpg")
